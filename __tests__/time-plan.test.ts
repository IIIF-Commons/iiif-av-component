...
describe('Time plan', () => {
  ...
  describe('Fixture 5 bugs', () => {
    test('next then previous', () => {
      ...
      expect(player.currentStop.rangeId).toEqual(`http://api.bl.uk/metadata/iiif/ark:/81055/vdc_100082592360.0x000007`);

      player.next();
      player.next();
      expect(player.currentStop.rangeId).toEqual(`http://api.bl.uk/metadata/iiif/ark:/81055/vdc_100082592360.0x000009`);
    ...
    test('going halfway through first range, then clicking back', () => {
      ...
      // Go to 1:30
      player.setRange('http://api.bl.uk/metadata/iiif/ark:/81055/vdc_100082592360.0x000007');
      player.setTime(timelineTime(1.5 * 60));

      expect(player.currentRange).toEqual(`http://api.bl.uk/metadata/iiif/ark:/81055/vdc_100082592360.0x000007`);
    ...
    test('going back from top range should stay on top range', () => {
      ...
      player.setRange('http://api.bl.uk/metadata/iiif/ark:/81055/vdc_100082592360.0x000002/top');
      player.setTime(timelineTime(0));
      player.previous();
    ...
    test('backwards through ranges', () => {
      ...
      player.setRange('http://api.bl.uk/metadata/iiif/ark:/81055/vdc_100082592360.0x000021');
  ...
  describe('Fixture 12 bugs', () => {
    test('going past half way point and then clicking back', () => {
      ...
      player.setRange('http://api.bl.uk/metadata/iiif/ark:/81055/vdc_100085750596.0x000006');

      expect(player.currentRange).toEqual('http://api.bl.uk/metadata/iiif/ark:/81055/vdc_100085750596.0x000006');
  ...
  describe('Fixture 16 bugs', () => {
    ...
    test('It should transition from the end of side/file 1 into the start of side/file 2', () => {
      ...
      player.setRange('http://api.bl.uk/metadata/iiif/ark:/81055/vdc_100094400914.0x000022');
  ...
  describe('Fixture 18 bugs', () => {
    ...
    test('backwards through ranges', () => {
      ...
      player.setRange('http://api.bl.uk/metadata/iiif/ark:/81055/vdc_100048367656.0x000009');
  ...
  describe('Fixture 26 bugs', () => {
     ...
     */
    test.todo('Bug: using the Previous button moves the focus out of the recording entirely.');
  });
  ...
  describe('Fixture 29 bugs', () => {
     ...
     */
    test.todo('Bug: Advancing past the first recording in the Index does not work');
  });
  ...
  describe('Fixture 35 bugs', () => {
     ...
     */
    test.todo('Bug: Playback stops unexpectedly at the penultimate child recording for the first parent');
  });
  ...
  describe('Fixture 37 bugs', () => {
     ...
     * (No fixture yet)
     */
    test.todo('Bug: Selecting the first child recording for the second parent from the Index does not work');
  });

  describe('Fixture 43 bugs', () => {
    test.todo('Bug: Advancing past the first recording from the Index does not work');
  });
